...
var Zotlib = {
    ...
    // Modified based on createShortened
    createShortenedOverwrite: function (file, type, mode, maxBytes, step) {
        ...
        while (true) {
            ...
            try {
                ...
                // Shorten the filename
                //
                // Shorten the filename to support appending the step at the end
                var uniqueFile = file.clone();
                while (true) {
                    let newBaseName = uniqueFile.leafName.substr(0, newLength - ext.length);
                    // Modified
